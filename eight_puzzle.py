...
def process_file(filename, algorithm, param):
    ...
    for line in file:
        ...
        try:
            ...
            if soln == None:
                print(new_line,': no solution' )
                
            else:  
                count += 1
                states += searcher.num_tested
                moves += soln.num_moves
                print(new_line,':', soln.num_moves, 'moves,', searcher.num_tested, 'states tested')
    ...
    if count > 0:   
        print('averages:', (moves/count), 'moves,', (states/count), 'states tested')
